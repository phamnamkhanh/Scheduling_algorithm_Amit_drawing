...
//     public  FPGA fpga;
     ...
     public  double sigma;
     public  double mu;
     public double schedule_length;
     public double leakage;
     public String filename;
        
        // constructor
    public Scheduling_algorithm( double a, double b, double c, double d, double e, double s, double m, String name){
//        graph = g;
//               
...
//                }
    ...
    // inputGraph1(graph);  
      ...
      // }
       ...
       schedule_length= graph.makespan;  
...
//  } 
    ...
    // example from paper 2
     public static void inputGraph2(Graph graphObject) {
    ...
    public static void inputGraph1(Graph graphObject) {
    ...
    graphObject.addEdge(6, 5, 1); 
     ...
     public static void constructGraph(Graph graph,String task_string,String value_string) {
        int check = 0;
        int kind=0;
     ...
     // MWD
   public static void inputGraph3(Graph graphObject) {
